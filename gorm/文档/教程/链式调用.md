...
这是  [完整方法列表](https://github.com/go-gorm/gorm/blob/master/chainable_api.go)，也可以查看  [SQL 构建器](https://gorm.io/zh_CN/docs/sql_builder.html)  获取更多关于  `Clauses`  的信息
...
GROM 定义了  `Session`、`WithContext`、`Debug`  方法做为  `新建会话方法`，查看[会话](https://gorm.io/zh_CN/docs/session.html)  获取详情
...
> **注意**  在示例 2 中，第一个查询会影响第二个查询生成的 SQL ，因为 GORM 复用  `Statement`  这可能会引发预期之外的问题，请参考  [线程安全](https://gorm.io/zh_CN/docs/method_chaining.html#goroutine_safe)  了解如何避免该问题。
