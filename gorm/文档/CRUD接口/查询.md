...
您可以使用  [内联条件](https://gorm.io/zh_CN/docs/query.html#inline_conditions)  来检索对象。 传入字符串参数时注意避免 SQL 注入问题，查看  [安全](https://gorm.io/zh_CN/docs/security.html)  获取详情
...
您还可以查看高级查询中的  [分组条件](https://gorm.io/zh_CN/docs/advanced_query.html#group_conditions)，它被用于编写复杂 SQL
...
参考  [预加载](https://gorm.io/zh_CN/docs/preload.html)  了解详情
